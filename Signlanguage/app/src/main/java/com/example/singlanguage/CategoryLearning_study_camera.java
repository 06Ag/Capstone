...
public class CategoryLearning_study_camera extends AppCompatActivity
    ...
    //수어 list
    final String[][] list = new String[][] {{"ㅐ [애]"},{"가방"},{"ㅂ [비읍]"},{"지폐"},{"결과 없음"},{"챔피언"},{"ㅊ [치읓]"},{"다지다"},{"춥다"},{"기둥"},{"컴퓨터"},{"문화"},{"손님"},{"데이트"},{"ㄷ [디귿]"},{"상의"},{"결과 없음"},{"만두"},{"ㅔ [에]"},{"8"},{"ㅓ [어]"},{"ㅡ [으]"},{"5"},{"4"},{"열매"},{"신사"},{"꾼"},{"ㄱ [기역]"},{"핸드백"},{"걸다"},{"건빵"}, {"ㅎ [히읗]"}, {"집"},{"ㅣ [이]"},{"가렵다"},{"ㅈ [지읒]"},{"죽"},{"꼬마"},{"ㅋ [키읔]"},{"법"},{"사랑"},{"만들다"},{"남자"},{"고기"},{"ㅁ [미음]"},{"가장"},{"산"},{"버섯"},{"ㄴ [니은]", "6"},{"9"},{"북쪽"},{"ㅗ [오]"},{"ㅚ [외]"},{"1", "ㅏ [아]"},{"고아"},{"ㅍ [피읖]"},{"탁구"},{"장소"},{"비행기"},{"가루"},{"발표"},{"호박"},{"읽다"},{"녹음기"},{"관계"},{"구출"},{"갈비"},{"떡"},{"ㄹ [리을]"},{"도로"},{"학교"},{"깨"},{"7"},{"ㅅ [시옷]"},{"노예","심부름"},{"남쪽"},{"서다"},{"선생님"},{"10", "ㅇ [이응]"},{"3"},{"ㅌ [티읕]"},{"단련"},{"2"},{"ㅜ [우]"},{"ㅢ [의]"},{"산골"},{"ㅟ [위]"},{"아내"},{"여자"},{"글"},{"ㅑ [야]"},{"ㅒ [얘]"},{"ㅖ [예]"},{"ㅕ [여]"},{"ㅛ [요]"},{"녀석"},{"ㅠ [유]"},{"0"}};
