...
public class Fragment2 extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.layout_giyeok)   intent.putExtra("name", "기역");
        else if(v.getId() == R.id.layout_nieun)   intent.putExtra("name", "니은");
        else if(v.getId() == R.id.layout_digeut)   intent.putExtra("name", "디귿");
        else if(v.getId() == R.id.layout_rieul)   intent.putExtra("name", "리을");
        else if(v.getId() == R.id.layout_mieum)   intent.putExtra("name", "미음");
        else if(v.getId() == R.id.layout_bieup)   intent.putExtra("name", "비읍");
        else if(v.getId() == R.id.layout_siot)   intent.putExtra("name", "시옷");
        else if(v.getId() == R.id.layout_ieung)   intent.putExtra("name", "이응");
        else if(v.getId() == R.id.layout_jieut)   intent.putExtra("name", "지읒");
        else if(v.getId() == R.id.layout_chieut)   intent.putExtra("name", "치읓");
        else if(v.getId() == R.id.layout_kieuk)   intent.putExtra("name", "키읔");
        else if(v.getId() == R.id.layout_tieut)   intent.putExtra("name", "티읕");
        else if(v.getId() == R.id.layout_pieup)   intent.putExtra("name", "피읖");
        else if(v.getId() == R.id.layout_hieut)   intent.putExtra("name", "히읗");
        else if(v.getId() == R.id.layout_a)   intent.putExtra("name", "아");
        else if(v.getId() == R.id.layout_ya)   intent.putExtra("name", "야");
        else if(v.getId() == R.id.layout_eo)   intent.putExtra("name", "어");
        else if(v.getId() == R.id.layout_yeo)   intent.putExtra("name", "여");
        else if(v.getId() == R.id.layout_o)   intent.putExtra("name", "오");
        else if(v.getId() == R.id.layout_yo)   intent.putExtra("name", "요");
        else if(v.getId() == R.id.layout_u)   intent.putExtra("name", "우");
        else if(v.getId() == R.id.layout_yu)   intent.putExtra("name", "유");
        else if(v.getId() == R.id.layout_eu)   intent.putExtra("name", "으");
        else if(v.getId() == R.id.layout_i)   intent.putExtra("name", "이");
        else if(v.getId() == R.id.layout_ae)   intent.putExtra("name", "애");
        else if(v.getId() == R.id.layout_yae)   intent.putExtra("name", "얘");
        else if(v.getId() == R.id.layout_e)   intent.putExtra("name", "에");
        else if(v.getId() == R.id.layout_ye)   intent.putExtra("name", "예");
        else if(v.getId() == R.id.layout_ui)   intent.putExtra("name", "의");
        else if(v.getId() == R.id.layout_oe)   intent.putExtra("name", "외");
        else if(v.getId() == R.id.layout_wi)   intent.putExtra("name", "위");
