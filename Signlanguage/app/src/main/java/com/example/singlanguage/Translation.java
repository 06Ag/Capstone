...
public class Translation extends AppCompatActivity
    ...
    public void recognise() {
        ...
        final String[] list = {"애","비읍","치읓","춥다", "컴퓨터", "손님","디귿","상의","에","8","어","으","5","4","열매","기역", "건빵", "히읗", "집","이","간지럽다","지읒","키읔", "남자", "고기", "약", "미음","니은","9","북쪽","오","외","1","피읖","가루","발표", "읽다", "갈비", "떡", "리을","학교", "7","시옷","남쪽", "선생님","10","3","티읕","2","우","의","위", "여자","야","얘","예","여","요","유","0"};
        for(int i=0; i<60; i++) {
